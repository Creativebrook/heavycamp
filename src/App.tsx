...
const cover=(track?:Track|null)=>track?.artworkUrl||(track?.coverArt?`/api/cover?id=${encodeURIComponent(track.coverArt)}`:'/icon.svg')
...
function Unlock({onDone}:{onDone:()=>void}){
  ...
  return <main className="unlock">
    <form className="unlock-card" onSubmit={async event=>{
      ...
      <img src="/icon.svg" alt="HeavyCamp"/>
...
export default function App(){
  ...
  if(locked===null)return <div className="splash"><img src="/icon.svg"/><strong>HeavyCamp</strong></div>
