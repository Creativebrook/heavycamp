const CACHE='heavycamp-shell-v4',SHELL=['/manifest.webmanifest','/icon-512.png'];
...
self.addEventListener('push',e=>{let d={};try{d=e.data?e.data.json():{}}catch{}e.waitUntil(self.registration.showNotification(d.title||'HeavyCamp',{body:d.body||'New music is waiting for you.',icon:'/icon-512.png',badge:'/icon-512.png',tag:d.tag||'heavycamp',data:{url:d.url||'/'}}))});
